...
@ToString
@Entity
@Table(name = "TAB_EFD_C880", schema = "APL_EFD")
public class RegistroC880 extends Registro {
	...
	@Indice(valor = 6)
	private String vlUnitBcIcmsStEstoqueConv;
	...
	public RegistroC880(String linha) {
		super(linha);
	}
